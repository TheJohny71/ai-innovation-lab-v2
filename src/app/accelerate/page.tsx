...
export default function AcceleratePage() {
  ...
  // Added explicit typing for event handlers
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Rest of your JSX remains the same, but update event handlers */}
      <div className="relative min-h-screen">
        ...
        <div className="relative max-w-7xl mx-auto px-4 pt-24 pb-12">
          ...
          {/* Search & Filter Controls with updated event handlers */}
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredSolutions.map((solution: Solution) => (
              ...
              >
                {/* Solution card content remains the same */}
