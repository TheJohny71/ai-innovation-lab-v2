...
export const metadata: Metadata = {
  ...
  description: 'AI Powered Legal Innovation - Accelerating Disruption Through Cultural Mindset Change',
  keywords: 'AI, legal innovation, legal tech, law firm innovation, legal disruption',
