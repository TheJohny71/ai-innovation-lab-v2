...
export const WelcomeSvg: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Refined background particles */}
      <g opacity="0.4">
        {/* Your particle circles with animations */}
      ...
      <g transform="translate(600, 400)" textAnchor="middle">
        ...
        <g transform="translate(0, 300)">
          ...
          />
          <text x="-240" y="8" fill="#E5E7EB" style={{fontSize: "19px", fontWeight: 400, letterSpacing: "0.5px"}}>
            Welcome
          </text>
          <text x="-80" y="8" fill="#E5E7EB" style={{fontSize: "19px", fontWeight: 400, letterSpacing: "0.5px"}}>
            Solutions
          </text>
          <text x="80" y="8" fill="#E5E7EB" style={{fontSize: "19px", fontWeight: 400, letterSpacing: "0.5px"}}>
            Disruption
