    ...
    <div className="relative w-full h-[480px] flex items-center justify-center">
      <div className="absolute inset-0 flex items-center justify-center">
        {solutions.map((solution, index) => (
          <div
            key={solution.id}
            className={`absolute left-1/2 -translate-x-1/2 w-full max-w-3xl transition-all duration-500 ease-in-out cursor-pointer ${getCardStyles(getPosition(index))}`}
          ...
          >
            <div
              className={`solution-card-content rounded-2xl bg-slate-900/60 border border-white/10 backdrop-blur-sm
                         ${solution.borderHover} transition-all duration-300 hover:bg-white/5`}
            >
              <div className="p-8">
                <div className="flex flex-col space-y-6">
                  <div>
                    ...
                    <p className="text-slate-400 text-lg mt-4 line-clamp-2">
