...
export function AnimatedServiceBox({
  ...
  return (
    ...
    >
      <div
        className={`rounded-xl border bg-opacity-5 backdrop-blur-sm transition-all duration-300
                   p-6 relative overflow-hidden group-hover:scale-105
                   border-${color}-500/10 bg-${color}-500`}
      >
        {/* Animated icon container */}
        <div className="relative mb-4">
          <div 
            className={`absolute inset-0 blur-sm opacity-20 bg-${color}-500 
